...
- Define 2 engines: Comma-separated

- Create base package that will store code common for all the engines.

- Import stuff from 2nd engine:
  Maybe make 2nd engine be accessible as nefertari.engine attribute. E.g. nefertari.engine.secondary.

- Deciding which model to query goes like:
